 ...
 * File:   main.cpp
 * Author: Andrew Kim
 * Created on March 12, 2014, 7:16 PM
 * Assignment 1
 */
...
int getN();
void def(int);
//Problem 1 with Functions
void problem1();
int *allocate(int);
//Problem 2 with Functions
void problem2();
...
//Problem 4
void problem4();
//Problem 5 with Functions
void problem5();
int doSomething(int *,int *);
//Problem 6 with Functions
void problem6();
void arrSelectSort(int *[], int);
void showArray(const int [], int);
void showArrPtr(int *[], int);
//Problem 7 with Functions
void problem7();
void deSort(int *[], int);
//Problem 8 with Functions
void problem8();
void copyrev(int *,int *,int);
//Problem 9 with Functions
void problem9();
int *expand(int *,int);
...
void Menu(){
    ...
    cout<<"Type 1 for 9.1 (Array Allocator)"<<endl;
    cout<<"Type 2 for 9.2 (Test Scores #1)"<<endl;
    cout<<"Type 3 for 9.3 (Drop Lowest Score)"<<endl;
    cout<<"Type 4 for 9.4 (Test #2)"<<endl;
    cout<<"Type 5 for 9.5 (Pointer Rewrite)"<<endl;
    cout<<"Type 6 for 9.6 (Case Study Modification #1)"<<endl;
    cout<<"Type 7 for 9.7 (Case STudy Modification #2)"<<endl;
    cout<<"Type 8 for 9.10 (Reverse Array)"<<endl;
    cout<<"Type 9 for 9.11 (Array Expander)"<<endl;
    cout<<"Type 10 for Mean, Median, and Mode problem"<<endl;
...
void copyrev(int *a,int *b,int n){
    for(int i=0;i<n;i++){
        b[9-i]=a[i];
    }
}
